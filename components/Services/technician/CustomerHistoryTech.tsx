...
interface CustomerPortfolio {
  ...
  completedRequests: RepairRequest[];
  totalTickets: number;
}
...
export const CustomerHistoryTech: React.FC = () => {
        ...
        try {
          ...
          reqs.forEach(req => {
            ...
            if (!customerMap[uid]) {
              customerMap[uid] = {
                userId: uid,
                userName: req.userName || 'Generic Client',
                activeRequests: [],
                completedRequests: [],
                totalTickets: 0
              };
          ...
          const portfolioList = Object.values(customerMap);
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {loading ? (
        <div className="p-8 text-center text-slate-500">Retrieving active client registries...</div>
      ) : portfolios.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="glass rounded-2xl border border-white/5 p-4 space-y-3 h-[500px] overflow-y-auto scrollbar-hide">
             <h3 className="text-xs font-bold uppercase tracking-widest text-slate-500 px-2 pb-1">Client Rolodex</h3>
                ...
                {portfolios.map(p => (
                   ...
                   >
                      <div className="min-w-0 flex-1">
                         ...
                         <span className="text-[10px] text-slate-500 font-mono">UID: ...{p.userId.substring(5, 11)}</span>
                      </div>
          ...
          {/* Customer Support Portfolio Detail Right Side */}
          <div className="md:col-span-2 glass rounded-2xl border border-white/5 p-6 space-y-6 h-[500px] overflow-y-auto scrollbar-hide">
             {activePortfolio ? (
                <div className="space-y-6">
                   ...
                   {/* Historical Resolved Tickets Segment */}
